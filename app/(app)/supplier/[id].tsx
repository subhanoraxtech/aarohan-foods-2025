...
const NotificationCard = ({
  ...
  const deliveryTime = item.deliveryTime || "6:30 AM";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <YStack flex={1} gap={10}>
          ...
          <YStack gap={10} marginTop={14}>
            ...
            <XStack alignItems="center" gap={8}>
              ...
              >
                <Icon name="dollar-sign" type="feather" size={14} color="#1EA556" />
              </View>
              <Text fontSize={13} color="#1EA556" fontWeight="600">
          ...
          {isReady && (
            <XStack
              ...
              borderColor="#A7F3D0"
            >
              <Icon name="check" type="feather" size={18} color="#10B981" />
              <Text
                fontSize={14}
                fontWeight="700"
                color="#10B981"
          ...
          {isDelivered && (
            <XStack
              ...
              borderColor="#A7F3D0"
            >
              <Icon name="truck" type="feather" size={18} color="#059669" />
              <Text
                fontSize={14}
                fontWeight="700"
                color="#059669"
          ...
          {isCancelled && (
            <XStack
              ...
              borderColor="#FECACA"
            >
              <Icon name="x" type="feather" size={18} color="#EF4444" />
              <Text
                fontSize={14}
                fontWeight="700"
                color="#EF4444"
        ...
        {/* RIGHT SIDE */}
        <YStack alignItems="center" justifyContent="space-between" minHeight={160}>
          {/* Order Number */}
          <View
            style={{
              backgroundColor: isReady || isDelivered ? "#ECFDF5" : isCancelled ? "#FEF2F2" : "#FFF7ED",
          ...
          >
            <Text fontSize={18} fontWeight="900" color={statusColor} letterSpacing={-0.5}>
              #{item.orderNumber}
            </Text>
          </View>
          ...
          {canTakeAction ? (
            ...
            >
              {isUpdating ? (
                ...
                <XStack alignItems="center" gap={6}>
                  <Icon name="check" type="feather" size={13} color="white" />
                  <Text color="white" fontSize={11} fontWeight="700" textAlign="center">
            ...
            <YStack alignItems="center" gap={6}>
              ...
              <Text fontSize={11} color={statusColor} fontWeight="700" letterSpacing={0.5}>
                {getStatusText(item.status).toUpperCase()}
              </Text>
            </YStack>
          )}
      ...
      >
        ...
        >
          <XStack alignItems="center" justifyContent="space-between" marginBottom={12}>
            <YStack>
              <Text fontSize={18} fontWeight="800" color="#1E293B">
                Orders Progress
              </Text>
              <Text fontSize={13} color="#64748B" marginTop={2}>
            ...
            <View
              style={{
                backgroundColor: progressPercentage === 100 ? '#10B981' : '#FE8C00',
          ...
          {/* Status Summary */}
          <XStack justifyContent="space-between" marginTop={12} flexWrap="wrap" gap={8}>
            <XStack alignItems="center" gap={8}>
              <View
                style={{
                  width: 12,
              ...
              />
              <Text fontSize={12} color="#64748B" fontWeight="500">
