...
//   // Refetch notifications whenever the screen comes into focus
//   useFocusEffect(
//     useCallback(() => {
//       refetch();
//     }, [refetch])
...
//     const handlePress = () => {
//       // For bundle-related notifications, navigate to the bundle details
//       if (
...
//       // For other order-related notifications
//       const navDate = item.bundleDate
//         ? moment(item.bundleDate).format("YYYY-MM-DD")
//         : moment().format("YYYY-MM-DD");
